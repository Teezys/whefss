...
*/
@Data
public class WhefssAccInfoUpdateReqBO {
    /**
    * 监管账户账号
    */
    ...
    * 企业名称
    */
    @ECPDict(required = true,length = 15, message = "corpName值不合法")
    ...
    * 日终余额
    */
    @ECPDict(required = true, message = "dayendAmt值不合法")
    private YGAmt dayendAmt;

    /**
    * 操作时间Yyyymmddhhmiss
    */
    @ECPDict(required = true,length = 21, message = "monitorTime值不合法")
    private String monitorTime;

    /**
    * 销户通知书编号
    */
    @ECPDict(required = true,length = 16, message = "cloNtcNo值不合法")
    private String cloNtcNo;

    /**
    * 变更时间Yyyymmddhhmiss
    */
    @ECPDict(required = true,length = 21, message = "changeTime值不合法")
