...
public class AESEncryptUtils {
     ...
     * 偏移量
     */
    private static final String IV_STRING = "1122334455667788";
     ...
     * @throws Exception 加密（使用这个）
     */
    public static String aesBase64Encrypt(String content, String key, String iv)
            throws Exception {
        byte[] byteContent = content.getBytes("UTF-8");
        // 注意，为了能与 iOS 统一
        // 这里的 key 不可以使用 KeyGenerator、SecureRandom、SecretKey 生成
     ...
     * @throws Exception 解密（使用这个）
     */
    public static String aesBase64decrypt(String content, String key, String iv)
            throws Exception {
        // base64 解码
        byte[] encryptedBytes = base64Decode(content);
        byte[] enCodeFormat = key.getBytes();
