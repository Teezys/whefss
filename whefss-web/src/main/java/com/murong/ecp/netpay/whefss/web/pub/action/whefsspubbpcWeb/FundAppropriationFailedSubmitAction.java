 ...
 */
@Service("fundAppropriationFailedSubmit")
@Slf4j
public class FundAppropriationFailedSubmitAction extends BaseAction {
    /**
     * 资金拨付流水表
     */
    @Autowired
    ...
    public ResultT<WhefssAccInSendDO> execute(YGBizMessageContext bizCtx, WhefssAccOutSendAddReqBO reqBO) throws YGException {
        ...
        whefssAccOutSendDO.setTime(reqBO.getTime()+"000000");
        ...
        whefssAccOutSendDO.setFlag(WhefssConstant.TXN_STS_F);
