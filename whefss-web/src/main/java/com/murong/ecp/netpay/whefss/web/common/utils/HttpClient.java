...
public class HttpClient {
    ...
    public static Map<String, String> post(Map<String, String> reqData, String reqUrl, String encoding, int timeOut, Logger logger) {
        Map<String, String> rspData = new HashMap<String, String>();
        logger.info("请求武汉房管地址：" + reqUrl);
        return rspData;
    }
    ...
    public static String doGet(String url,String charset, String contentType,
        ...
        try {
            ...
            RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(connectTimeout)// 连接主机服务超时时间
                    .setConnectionRequestTimeout(requestTimeout)// 请求超时时间
    ...
    public static String doPost(String url, Map<String, Object> paramMap,String reqData, String charset, String contentType,
                                int connectTimeout, int requestTimeout, int socketTimeout) {
        CloseableHttpClient httpClient = null;
        ...
        // 封装post请求参数
        StringEntity stringEntity = new StringEntity(reqData, charset);
