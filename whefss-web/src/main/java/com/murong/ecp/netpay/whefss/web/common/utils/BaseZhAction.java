 ...
 */
public abstract class BaseZhAction extends AbstractTransaction {
    ...
    public void doProcess(YGBizMessageContext bizCtx) throws YGException {
        ...
        try {
            ...
            if (resultT instanceof PageResultT) {
                ...
                if (pageEntity != null) {
                    WhEDBUtil.obj2edb(((PageResultT) resultT).getPageEntity(), root);
                }
            }
            ...
            if (resultT.getData() != null) {
                if (resultT.getData() instanceof YGEDB) {
                    ...
                    WhEDBUtil.list2edbNam((List) resultT.getData(), "data", root);
                } else {
                    YGEDB recNod = root.addNode("data");
                    WhEDBUtil.obj2edbNam(resultT.getData(), recNod);
                }
            }
        } catch (Throwable t) {
